...
@class SpringBoard; @class SBInCallAlertManager; @class SBStatusBarManager; @class PHInCallUIUtilities; @class MPTelephonyManager; @class TUCallCenter; @class CNContactStore; @class TUCall; 
