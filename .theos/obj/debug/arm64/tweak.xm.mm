...
@class CNContactStore; @class SBStatusBarManager; @class MPTelephonyManager; @class SpringBoard; @class PHInCallUIUtilities; @class TUCallCenter; @class SBInCallAlertManager; @class TUCall; 
