...
@class TUCall; @class SBStatusBarManager; @class SBInCallAlertManager; @class CNContactStore; @class TUCallCenter; @class MPTelephonyManager; @class PHInCallUIUtilities; @class SpringBoard; 
...
static void _logos_method$_ungrouped$SpringBoard$showCallBanner(_LOGOS_SELF_TYPE_NORMAL SpringBoard* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
	...
	[UIView animateWithDuration:0.3f animations:^{
		...
		self.callWindow.center = CGPointMake(self.callWindow.center.x, ([((SBStatusBarContainer *)[MSHookIvar<NSHashTable *>((SBStatusBarManager *)[_logos_static_class_lookup$SBStatusBarManager() sharedInstance], "_statusBars") anyObject]).statusBar currentFrame].size.height) + 50);
	}
