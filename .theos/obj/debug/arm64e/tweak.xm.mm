...
@class SpringBoard; @class TUCall; @class SBStatusBarManager; @class CNContactStore; @class MPTelephonyManager; @class PHInCallUIUtilities; @class TUCallCenter; @class SBInCallAlertManager; 
